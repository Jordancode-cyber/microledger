...
export default function VendorRegistration() {
  ...
  const handleContinue = () => {
    if (businessName && phoneNumber) {
      router.push({
        pathname: '/pin-setup',
        params: { userType: 'vendor', businessName, phoneNumber }
      });
    }
  };

  const isFormValid = businessName.length > 0 && phoneNumber.length > 0;
  ...
  return (
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.subtitle}>Register your business to start sending change</Text>
